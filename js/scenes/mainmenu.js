...
class MainMenu extends Phaser.Scene {
    ...
    create(){
      ...
      this.creditText = this.add.text(270, 285, "Credits", { fontSize: "64px", fill: "#000" , strokeThickness : 10, });
    ...
    changeToCredit(){
      ...
      const title = this.add.text(50, 50, "Játékot készítette:", { fontSize: "64px", fill: "#000" , strokeThickness : 5, });
      const name1 = this.add.text(50, 150, "Érsek Norbert IIJU0Z", { fontSize: "56px", fill: "#000" , strokeThickness : 5, });
      const name2 = this.add.text(50, 250, "Kacsir András", { fontSize: "56px", fill: "#000" , strokeThickness : 5, });
      const name3 = this.add.text(50, 350, "Pogonyi Ábel TR6FKP", { fontSize: "56px", fill: "#000" , strokeThickness : 5, });
